                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="ukuran">Ukuran (GB/MB/TB)</label>
                                                            ...
                                                            <label for="satuan">ID Barcode</label>
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								...
								<div class="form-group">
									...
									<input name="satuan" type="text" class="form-control" placeholder="ID Barcode">
								</div>
								<div class="form-group">
									<label>Lokasi</label>
